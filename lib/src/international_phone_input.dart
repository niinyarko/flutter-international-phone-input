...
typedef OnPhoneNumberChange = void Function(String phoneNumber,
    String? internationalizedPhoneNumber, String? isoCode, String? dialCode);

class InternationalPhoneInput extends StatefulWidget {
  final OnPhoneNumberChange? onPhoneNumberChange;
          ...
          DropdownButtonHideUnderline(
            child: Padding(
              ...
              child: DropdownButton<Country>(
                ...
                items:
                    itemList.map<DropdownMenuItem<Country>>((Country? value) {
